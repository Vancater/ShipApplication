...
namespace ShipApplication
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            Texture2D tex = this.Content.Load<Texture2D>("Ship1");
            Vector2 stage = new Vector2(graphics.PreferredBackBufferWidth,
                graphics.PreferredBackBufferHeight);
            Vector2 pos = new Vector2(stage.X / 2, stage.Y / 2);
            
            //Vector2 speed = new Vector2(1, 1); //same as the following line
            Vector2 speed = Vector2.One;
            ship = new Ship(this, spriteBatch, tex, pos, speed, stage);
